...
INSERT INTO drones (drone_id, node_id, name, model, operational_status, last_maintenance, max_flight_time, home_lat, home_lng, roam_radius_km) VALUES
...
('DRONE_FR1_01', 'FR1'), ('DRONE_FR1_02', 'FR1'), ('DRONE_FR1_03', 'FR1'),
('DRONE_FR2_01', 'FR2'), ('DRONE_FR2_02', 'FR2'), ('DRONE_FR2_03', 'FR2'),
('DRONE_FR9_01', 'FR9'), ('DRONE_FR9_02', 'FR9'),
('DRONE_FR10_01', 'FR10'), ('DRONE_FR10_02', 'FR10'), ('DRONE_FR10_03', 'FR10'),
('DRONE_FR13_01', 'FR13'), ('DRONE_FR13_02', 'FR13'), ('DRONE_FR13_03', 'FR13')
ON CONFLICT (drone_id) DO UPDATE SET region_id = EXCLUDED.region_id;
