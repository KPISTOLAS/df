...
ALTER TABLE IF EXISTS drones ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS drone_regions ENABLE ROW LEVEL SECURITY;
...
DROP POLICY IF EXISTS "anon_read_drones" ON drones;
CREATE POLICY "anon_read_drones"
ON drones
FOR SELECT
TO anon, authenticated
USING (true);

DROP POLICY IF EXISTS "anon_read_drone_regions" ON drone_regions;
CREATE POLICY "anon_read_drone_regions"
ON drone_regions
FOR SELECT
TO anon, authenticated
USING (true);
